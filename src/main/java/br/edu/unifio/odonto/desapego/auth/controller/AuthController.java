package br.edu.unifio.odonto.desapego.auth.controller;

import br.edu.unifio.odonto.desapego.auth.dto.AuthResponse;
import br.edu.unifio.odonto.desapego.auth.dto.LoginRequest;
...
@Tag(name = "Auth", description = "Registro e login (JWT)")
...
public class AuthController {
    ...
    @Operation(summary = "Registrar usuário", description = "Cria conta e retorna token JWT")
    ...
    public ResponseEntity<ApiResponse<AuthResponse>> login(@Valid @RequestBody LoginRequest request) {
        AuthResponse auth = userService.login(request.getEmail(), request.getPassword());
